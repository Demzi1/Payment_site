  ...
  return (
    <section id='home' className={`flex md:flex-row flex-col ${styles.padding}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <h1 className=' font-semibold font-poppins ss:text-[72px] text-[52px] ss:leading-[100px] leading-[75px] text-white w-full'>
          Payment Method
        </h1>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Our team of expert uses a methodology to identify the credit cards most likelly to fit your needs. 
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        ...
        <div className=' white__gradient rounded-full absolute z-[1] w-[80%] h-[85%] bottom-40'/>
        <div className=' blue__gradient absolute z-[0] w-[50%] h-[50%] right-20 bottom-20'/>
      </div>
